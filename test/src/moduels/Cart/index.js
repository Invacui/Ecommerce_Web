  ...
  return (
    <div className="h-screen bg-gray-100 pt-20">
      ...
      <div className="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0">
        <div className="rounded-lg md:w-2/3 overflow-auto" style={{ maxHeight: '800px' }}>
          {cart.map((item) => (
            <div
              key={item.id}
              className="justify-between mb-6 rounded-lg bg-white p-9 shadow-md sm:flex sm:justify-start"
            >
              <img
                src={item.image}
                alt="product-image"
                className="rounded-lg md:w-40 h-20 cursor-pointer duration-150"
        ...
        <div className="mt-6 h-full rounded-lg border bg-white p-6 shadow-md md:mt-0 md:w-1/3">
          ...
          <div className="flex justify-between">
            ...
            <div className="">
              <p className="mb-1 text-lg font-bold" value={total_price}>
                ${total_price = (subtotal + shippingprice).toFixed(2)}
              </p>
